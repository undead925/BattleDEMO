...
*/
var FlyUnit = function (state, gridX, gridY, unitAttr, camp){
...
FlyUnit.prototype = Object.create(H3Unit.prototype)
FlyUnit.prototype.constructor = FlyUnit;

H3Unit.Component.install.call(FlyUnit.prototype, [
    'Act',
    'Move',
    'Fly',
    'Attack'
